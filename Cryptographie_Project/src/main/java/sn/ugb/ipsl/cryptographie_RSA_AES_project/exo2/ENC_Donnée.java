...
public class ENC_Donnée {

    private Cipher cipher;

    public ENC_Donnée(File originalFile, File encrypted, SecretKeySpec secretKey, String cipherAlgorithm) 
    ...
    private void writeToFile(File output, byte[] toWrite) 
        ...
        fos.flush();
        fos.close();
        System.out.println("Le fichier a été chiffrée avec succès. ");
